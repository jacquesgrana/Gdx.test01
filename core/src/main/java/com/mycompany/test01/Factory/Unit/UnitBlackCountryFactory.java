...
public class UnitBlackCountryFactory implements UnitFactoryInterface {
    ...
    private final CombatPropsFactoryInterface combatPropsFactory = new CombatPropsBlackCountryFactory();
    ...
    public ArtiUnit createArtiUnit(String name, String acronym, boolean isElite, boolean usesWhiteStroke, int regRank) {
        return new ArtiUnit(
            ...
            usesWhiteStroke,
            regRank,
            combatPropsFactory.getArtiMediumCombatProps(),
            artiPropsFactory.getArtiMediumRangeMedium()
            );
    }
    ...
    public DivisionGroup createInfDivision(String divName, String acronym) {
        ...
        InfantryRecoCompanyUnit reco_company = new InfantryRecoCompanyUnit(divName + " reco", acronym, this.country, false, false, 0, combatPropsFactory.getInfantryRecoCompMediumCombatProps());
    ...
    public DivisionGroup createEliteInfDivision(String divName, String acronym) {
        ...
        HeavyAntiAirUnit anti_air_01 = new HeavyAntiAirUnit(divName + " heavy_anti_air", acronym, this.country, true, false, true, 0, combatPropsFactory.getHeavyAntiAirEliteCombatProps());
    ...
    public DivisionGroup createMotoInfDivision(String divName, String acronym) {
        ...
        // 1 Anti tank
        MotoAntiTankUnit anti_tank_01 = new MotoAntiTankUnit(divName + " anti_tank", acronym, this.country, false, false, false, 0, combatPropsFactory.getMotoAntiTankMediumCombatProps());
        // 1 Eng
    ...
    public BrigadeGroup createEliteMecaBrigade(String name, String acronym) {
        BrigadeGroup brigade = new BrigadeGroup(name, acronym, this.country, false, true, true, true, combatPropsFactory.getHeadQuarterEliteCombatProps());

        MecaInfUnit mecaInfUnit01 = new MecaInfUnit(name + " meca inf 1-3", acronym, this.country, true, false, true, 1, combatPropsFactory.getMecaInfEliteCombatProps());
        MecaInfUnit mecaInfUnit02 = new MecaInfUnit(name + " meca inf 2-3", acronym, this.country, true, false, true, 2, combatPropsFactory.getMecaInfEliteCombatProps());
        MecaInfUnit mecaInfUnit03 = new MecaInfUnit(name + " meca inf 3-3", acronym, this.country, true, false, true, 3, combatPropsFactory.getMecaInfEliteCombatProps());

        HeavyTankUnit heavyTankUnit = new HeavyTankUnit(name + " heavy tank 1-3", acronym, this.country, true, false, true, 1, combatPropsFactory.getHeavyTankEliteCombatProps());
        TankUnit tankUnit01 = new TankUnit(name + " tank 2-3", acronym, this.country, true, false, true, 2, combatPropsFactory.getTankEliteCombatProps());
        TankUnit tankUnit02 = new TankUnit(name + " tank 3-3", acronym, this.country, true, false, true, 3, combatPropsFactory.getTankEliteCombatProps());

        MecaArtiUnit mecaArtiUnit01 = new MecaArtiUnit(name + " meca arti 1-3", acronym, this.country, true, false, true, 1, combatPropsFactory.getMecaArtiEliteCombatProps(), artiPropsFactory.getMecaArtiElite());
        MecaArtiUnit mecaArtiUnit02 = new MecaArtiUnit(name + " meca arti 2-3", acronym, this.country, true, false, true, 2, combatPropsFactory.getMecaArtiEliteCombatProps(), artiPropsFactory.getMecaArtiElite());
        MotoRocketArtiUnit motoRocketArtiUnit = new MotoRocketArtiUnit(name + " moto rocket arti 3-3", acronym, this.country, true, false, true, 3, combatPropsFactory.getMotoRocketArtiEliteCombatProps(), artiPropsFactory.getRocketHigh());

        MotoHeavyAntiAirUnit motoHeavyAntiAirUnit = new MotoHeavyAntiAirUnit(name + " heavy moto anti air", acronym, this.country, true, false, true, 0, combatPropsFactory.getMotoAntiAirEliteCombatProps());
        MotoEngineerUnit motoEngineerUnit = new MotoEngineerUnit(name + " moto eng", acronym, this.country, true, false, true, 0, combatPropsFactory.getMotoEngineerInfEliteCombatProps());
        MecaRecoUnit mecaRecoUnit = new MecaRecoUnit(name + " meca reco", acronym, this.country, true, true, true, 0, combatPropsFactory.getMecaRecoEliteCombatProps());
