...
public class TransportPropsRedCountryFactory implements TransportPropsFactoryInterface {

    private final int CAPACITY_LOW = 12;
    private final int CAPACITY_MEDIUM = 25;
    private final int CAPACITY_HIGH = 50;
