...
public class TransportPropsBlackCountryFactory implements TransportPropsFactoryInterface {

    private final int CAPACITY_LOW = 15;
    private final int CAPACITY_MEDIUM = 30;
