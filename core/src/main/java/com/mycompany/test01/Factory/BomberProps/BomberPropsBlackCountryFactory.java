...
public class BomberPropsBlackCountryFactory implements BomberPropsFactoryInterface {

    private final int BOMB_ATTACK_LOW = 3;
    private final int BOMB_ATTACK_MEDIUM = 5;
    private final int BOMB_ATTACK_HIGH = 8;

    private final int ACCURACY_LOW = 2;
    private final int ACCURACY_MEDIUM = 5;
    private final int ACCURACY_HIGH = 8;
