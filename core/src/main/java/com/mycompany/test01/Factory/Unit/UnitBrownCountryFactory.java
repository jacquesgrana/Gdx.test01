...
import com.mycompany.test01.Factory.CombatProps.CombatPropsBrownCountryFactory;
...
public class UnitBrownCountryFactory implements UnitFactoryInterface {
    ...
    private final CombatPropsFactoryInterface combatPropsFactory = new CombatPropsBrownCountryFactory();
