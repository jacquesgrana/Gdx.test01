...
public class ObserverPropsGreenCountryFactory implements ObserverPropsFactoryInterface {

    private final int VISION_RANGE_LOW = 5;
    private final int VISION_RANGE_MEDIUM = 7;
    private final int VISION_RANGE_HIGH = 11;

    private final int VISION_ACCURACY_LOW = 6;
    private final int VISION_ACCURACY_MEDIUM = 9;
