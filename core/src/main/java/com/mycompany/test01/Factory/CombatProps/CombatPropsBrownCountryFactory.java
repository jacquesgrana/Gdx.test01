...
public class CombatPropsBrownCountryFactory implements CombatPropsFactoryInterface {
    ...
    private final int HARD_ATTACK_ELITE = 15;
    private final int HARD_ATTACK_MEDIUM = 13;
    ...
    private final int SOFT_DEFENSE_ELITE = 14;
    private final int SOFT_DEFENSE_MEDIUM = 10;
    private final int SOFT_DEFENSE_LOW = 6;
    private final int SOFT_DEFENSE_NON_COMBAT = 3;

    private final int HARD_DEFENSE_ELITE = 15;
    private final int HARD_DEFENSE_MEDIUM = 12;
    private final int HARD_DEFENSE_LOW = 6;
    private final int HARD_DEFENSE_NON_COMBAT = 2;

    private final int AIR_DEFENSE_ELITE = 14;
    ...
    private final int SPEED_CAV_ELITE = 12;
    private final int SPEED_CAV_MEDIUM = 10;
    private final int SPEED_CAV_LOW = 9;
