...
public class CombatPropsBlueCountryFactory implements CombatPropsFactoryInterface {
    ...
    private final int AIR_DEFENSE_ELITE = 11;
    ...
    private final int SPEED_CAV_LOW = 11;
