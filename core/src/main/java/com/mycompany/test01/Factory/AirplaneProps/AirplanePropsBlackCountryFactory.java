...
public class AirplanePropsBlackCountryFactory implements AirplanePropsFactoryInterface {

    private final int PLANE_COUNT_LOW = 12;
    private final int PLANE_COUNT_MEDIUM = 24;
    private final int PLANE_COUNT_HIGH = 36;

    private final int AIR_DEFENSE_LOW = 6;
    private final int AIR_DEFENSE_MEDIUM = 9;
    private final int AIR_DEFENSE_HIGH = 12;

    private final int AIR_ATTACK_LOW = 8;
    private final int AIR_ATTACK_MEDIUM = 10;
    private final int AIR_ATTACK_HIGH = 14;

    private final int MORAL_LOW = 6;
    private final int MORAL_MEDIUM = 7;
    private final int MORAL_HIGH = 9;
