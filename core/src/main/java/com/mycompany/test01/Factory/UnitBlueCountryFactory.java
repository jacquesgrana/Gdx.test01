...
public class UnitBlueCountryFactory implements UnitFactoryInterface {
    ...
    public CavalryUnit createCavalryUnit(String name, String acronym, boolean isElite, boolean isMotorised, boolean usesWhiteStroke, int regRank) {
        return new CavalryUnit(name, acronym, CountryEnum.BLUE_COUNTRY, isElite, isMotorised, false, usesWhiteStroke, regRank);
    }
    ...
    public MarineUnit createMarineUnit(String name, String acronym, boolean isElite, boolean isMotorised, boolean usesWhiteStroke, int regRank) {
        return new MarineUnit(name, acronym, CountryEnum.BLUE_COUNTRY, isElite, isMotorised, false, usesWhiteStroke, regRank);
    }
    ...
    public MecaRecoUnit createMecaRecoUnit(String name, String acronym, boolean isElite, boolean isMotorised, boolean usesWhiteStroke, int regRank) {
        return new MecaRecoUnit(name, acronym, CountryEnum.BLUE_COUNTRY, isElite, isMotorised, false, usesWhiteStroke, regRank);
    }
    ...
    public DivisionGroup createInfDivision(String divName, String acronym) {
        ...
        InfantryRecoCompanyUnit reco_company = new InfantryRecoCompanyUnit(divName + " reco", acronym, CountryEnum.BLUE_COUNTRY, false, false, false, 0);
    ...
    public DivisionGroup createEliteInfDivision(String divName, String acronym) {
        ...
        // todo 1 reco inf company
        InfantryRecoCompanyUnit reco_company = new InfantryRecoCompanyUnit(divName + " reco", acronym, CountryEnum.BLUE_COUNTRY, true, false, true, 0);
