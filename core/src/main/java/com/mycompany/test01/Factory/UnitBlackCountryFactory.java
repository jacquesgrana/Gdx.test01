...
public class UnitBlackCountryFactory implements UnitFactoryInterface {
    ...
    {
        return new MountainArtiUnit(name, acronym, this.country, isElite, false, usesWhiteStroke, regRank, new ArtiProps(8, 6, 4, 2));
    }
    ...
    public ArtiUnit createArtiUnit(String name, String acronym, boolean isElite, boolean usesWhiteStroke, int regRank) {
        return new ArtiUnit(
            ...
            usesWhiteStroke,
            regRank,
            // TODO utiliser constantes par pays
            new ArtiProps(10, 6, 3, 2));
    }
    ...
    public MortarArtiUnit createMortarArtiUnit(String name, String acronym, boolean isElite, boolean usesWhiteStroke, int regRank) {
        return new MortarArtiUnit(name, acronym, this.country, isElite, false, usesWhiteStroke, regRank, new ArtiProps(4, 4, 2, 1));
    }
    ...
    public MotoMortarArtiUnit createMotoMortarArtiUnit(String name, String acronym, boolean isElite, boolean usesWhiteStroke, int regRank) {
        return new MotoMortarArtiUnit(name, acronym, this.country, isElite, false, usesWhiteStroke, regRank, new ArtiProps(4, 4, 2, 1));
    }
    ...
    public RocketArtiUnit createRocketArtiUnit(String name, String acronym, boolean isElite, boolean usesWhiteStroke, int regRank) {
        return new RocketArtiUnit(name, acronym, this.country, isElite, false, usesWhiteStroke, regRank, new ArtiProps(8, 9, 3, 1));
    }

    @Override
    public ParaArtiUnit createParaArtiUnit(String name, String acronym, boolean isElite, boolean usesWhiteStroke, int regRank) {
        return new ParaArtiUnit(name, acronym, this.country, isElite, false, usesWhiteStroke, regRank, new ArtiProps(10, 6, 3, 2));
    }
    ...
    public ParaMortarArtiUnit createParaMortarArtiUnit(String name, String acronym, boolean isElite, boolean usesWhiteStroke, int regRank) {
        return new ParaMortarArtiUnit(name, acronym, this.country, isElite, false, usesWhiteStroke, regRank, new ArtiProps(4, 4, 2, 2));
    }
    ...
    public MotoArtiUnit createMotoArtiUnit(String name, String acronym, boolean isElite, boolean usesWhiteStroke, int regRank) {
        return new MotoArtiUnit(name, acronym, this.country, isElite, false, usesWhiteStroke, regRank, new ArtiProps(10, 6, 3, 2));
    }
    ...
    public MotoRocketArtiUnit createMotoRocketArtiUnit(String name, String acronym, boolean isElite, boolean usesWhiteStroke, int regRank) {
        return new MotoRocketArtiUnit(name, acronym, this.country, isElite, false, usesWhiteStroke, regRank, new ArtiProps(7, 8, 2, 1));
    }
    ...
    public DivisionGroup createInfDivision(String divName, String acronym) {
        ...
        // 3 art
        ArtiUnit art_01 = new ArtiUnit(divName + " art 1", acronym + "•1", this.country, false, false, false, 1, new ArtiProps(10, 6, 3, 2));
        ArtiUnit art_02 = new ArtiUnit(divName + " art 2", acronym + "•2", this.country, false, false, false, 2, new ArtiProps(10, 6, 3, 2));
        ArtiUnit art_03 = new ArtiUnit(divName + " art 3", acronym + "•3", this.country, false, false, false, 3, new ArtiProps(12, 8, 4, 3));
        // 1 Anti tank
    ...
    public DivisionGroup createEliteInfDivision(String divName, String acronym) {
        ...
        // 3 art
        ArtiUnit art_01 = new ArtiUnit(divName + " art 1", acronym + "•1", this.country, true, false, true, 1, new ArtiProps(12, 12, 10, 3));
        ArtiUnit art_02 = new ArtiUnit(divName + " art 2", acronym + "•2", this.country, true, false, true, 2, new ArtiProps(10, 8, 5, 2));
        ArtiUnit art_03 = new ArtiUnit(divName + " art 3", acronym + "•3", this.country, true, false, true, 3,new ArtiProps(10, 8, 5, 2));
        // 1 Anti tank
        ...
        HeavyAntiAirUnit anti_air_01 = new HeavyAntiAirUnit(divName + " heavy_anti_air", acronym, this.country, true, false, true, 0);
    ...
    public DivisionGroup createMotoInfDivision(String divName, String acronym) {
        ...
        // 3 art
        MotoArtiUnit art_01 = new MotoArtiUnit(divName + " art 1", acronym + "•1", this.country, false, false, false, 1, new ArtiProps(12, 8, 4, 2));
        MotoArtiUnit art_02 = new MotoArtiUnit(divName + " art 2", acronym + "•2", this.country, false, false, false, 2, new ArtiProps(10, 6, 3, 2));
        MotoArtiUnit art_03 = new MotoArtiUnit(divName + " art 3", acronym + "•3", this.country, false, false, false, 3, new ArtiProps(10, 6, 3, 2));
        // 1 Anti tank
    ...
    public BrigadeGroup createEliteMecaBrigade(String name, String acronym) {
        BrigadeGroup brigade = new BrigadeGroup(name, acronym, this.country, false, true, true, true);

        MecaInfUnit mecaInfUnit01 = new MecaInfUnit(name + " meca inf 1-3", acronym, this.country, true, false, true, 1);
        MecaInfUnit mecaInfUnit02 = new MecaInfUnit(name + " meca inf 2-3", acronym, this.country, true, false, true, 2);
        MecaInfUnit mecaInfUnit03 = new MecaInfUnit(name + " meca inf 3-3", acronym, this.country, true, false, true, 3);

        HeavyTankUnit heavyTankUnit = new HeavyTankUnit(name + " heavy tank 1-3", acronym, this.country, true, false, true, 1);
        ...
        MotoEngineerUnit motoEngineerUnit = new MotoEngineerUnit(name + " moto eng", acronym, this.country, true, false, true, 0);
        MecaRecoUnit mecaRecoUnit = new MecaRecoUnit(name + " meca reco", acronym, this.country, true, true, true, 0);

        brigade.addUnit(mecaInfUnit01);
        brigade.addUnit(mecaInfUnit02);
        brigade.addUnit(mecaInfUnit03);

        brigade.addUnit(heavyTankUnit);
        brigade.addUnit(tankUnit01);
        brigade.addUnit(tankUnit02);

        brigade.addUnit(mecaArtiUnit01);
        brigade.addUnit(mecaArtiUnit02);
        brigade.addUnit(motoRocketArtiUnit);

        brigade.addUnit(motoHeavyAntiAirUnit);
        brigade.addUnit(motoEngineerUnit);
        brigade.addUnit(mecaRecoUnit);
