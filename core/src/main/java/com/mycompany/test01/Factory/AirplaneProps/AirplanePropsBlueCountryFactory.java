...
public class AirplanePropsBlueCountryFactory implements AirplanePropsFactoryInterface {

    private final int PLANE_COUNT_LOW = 10;
    private final int PLANE_COUNT_MEDIUM = 20;
    private final int PLANE_COUNT_HIGH = 30;

    private final int AIR_DEFENSE_LOW = 5;
    private final int AIR_DEFENSE_MEDIUM = 8;
    private final int AIR_DEFENSE_HIGH = 10;

    private final int AIR_ATTACK_LOW = 7;
    ...
    private final int SPEED_HIGH = 13;
