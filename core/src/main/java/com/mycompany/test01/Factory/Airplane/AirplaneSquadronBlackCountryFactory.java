...
public class AirplaneSquadronBlackCountryFactory implements AirplaneSquadronFactoryInterface {
    ...
    private final AirplanePropsFactoryInterface airplanePropsFactory = new AirplanePropsBlackCountryFactory();
    private final BomberPropsFactoryInterface bomberPropsFactory = new BomberPropsBlackCountryFactory();
    private final ObserverPropsFactoryInterface observerPropsFactory = new ObserverPropsBlackCountryFactory();
    private final TransportPropsFactoryInterface transportPropsFactory = new TransportPropsBlackCountryFactory();
