...
public class AirplaneSquadronBlueCountryFactory implements AirplaneSquadronFactoryInterface {
    ...
    private final AirplanePropsFactoryInterface airplanePropsFactory = new AirplanePropsBlueCountryFactory();
    private final BomberPropsFactoryInterface bomberPropsFactory = new BomberPropsBlueCountryFactory();
    private final ObserverPropsFactoryInterface observerPropsFactory = new ObserverPropsBlueCountryFactory();
    private final TransportPropsFactoryInterface transportPropsFactory = new TransportPropsBlueCountryFactory();
