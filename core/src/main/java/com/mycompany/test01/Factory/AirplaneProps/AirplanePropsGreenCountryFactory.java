...
import com.mycompany.test01.Interface.AirplanePropsFactoryInterface;

public class AirplanePropsGreenCountryFactory implements AirplanePropsFactoryInterface {

    private final int PLANE_COUNT_LOW = 16;
    private final int PLANE_COUNT_MEDIUM = 32;
    private final int PLANE_COUNT_HIGH = 42;

    private final int AIR_DEFENSE_LOW = 7;
    private final int AIR_DEFENSE_MEDIUM = 11;
    private final int AIR_DEFENSE_HIGH = 16;

    private final int AIR_ATTACK_LOW = 9;
    private final int AIR_ATTACK_MEDIUM = 12;
    private final int AIR_ATTACK_HIGH = 17;

    private final int MORAL_LOW = 5;
    private final int MORAL_MEDIUM = 6;
    private final int MORAL_HIGH = 8;

    private final int AGILITY_LOW = 3;
    private final int AGILITY_MEDIUM = 6;
    private final int AGILITY_HIGH = 9;

    private final int SPEED_LOW = 6;
    private final int SPEED_MEDIUM = 9;
    private final int SPEED_HIGH = 12;

    private final int RANGE_LOW = 7;
    private final int RANGE_MEDIUM = 9;
    private final int RANGE_HIGH = 14;

    private final int VISIBILITY_LOW = 3;
    private final int VISIBILITY_MEDIUM = 6;
