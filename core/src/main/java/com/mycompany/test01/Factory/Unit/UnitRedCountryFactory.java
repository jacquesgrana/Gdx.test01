...
import com.mycompany.test01.Factory.ArtiProps.ArtiPropsRedCountryFactory;
import com.mycompany.test01.Factory.CombatProps.CombatPropsRedCountryFactory;
...
public class UnitRedCountryFactory implements UnitFactoryInterface {
    ...
    private final CombatPropsFactoryInterface combatPropsFactory = new CombatPropsRedCountryFactory();
    private final ArtiPropsFactoryInterface artiPropsFactory = new ArtiPropsRedCountryFactory();
    ...
    public DivisionGroup createInfDivision(String divName, String acronym) {
        ...
        InfantryUnit inf_03_01 = new InfantryUnit(divName + " inf 3-1", acronym + "•1•3", this.country, false, false, false, 3, combatPropsFactory.getInfantryMediumCombatProps());
        ...
        InfantryUnit inf_03_02 = new InfantryUnit(divName + " inf 3-2", acronym + "•2•3", this.country, false, false, false, 3, combatPropsFactory.getInfantryMediumCombatProps());
        ...
        InfantryUnit inf_03_03 = new InfantryUnit(divName + " inf 3-3", acronym + "•3•3", this.country, false, false, false, 3, combatPropsFactory.getInfantryMediumCombatProps());
        // 3 art
        ...
        // 1 Eng
        EngineerUnit engineer_01 = new EngineerUnit(divName + " engineer", acronym, this.country, false, false, false, 0, combatPropsFactory.getAntiAirMediumCombatProps());
    ...
    public BrigadeGroup createMotoInfBrigade(String brigName, String acronym) {
        BrigadeGroup brigade = new BrigadeGroup(brigName, acronym, this.country, false, false, true, false, combatPropsFactory.getHeadQuarterMediumCombatProps());

        // 3 * 3 inf
        MotoInfUnit inf_01_01 = new MotoInfUnit(brigName + " inf 1", acronym + "•1", this.country, false, false, false, 1, combatPropsFactory.getMotoInfMediumCombatProps());
        MotoInfUnit inf_02_01 = new MotoInfUnit(brigName + " inf 2", acronym + "•2", this.country, false, false, false, 2, combatPropsFactory.getMotoInfMediumCombatProps());
        MotoInfUnit inf_03_01 = new MotoInfUnit(brigName + " inf 3", acronym + "•3", this.country, false, false, false, 3, combatPropsFactory.getMotoInfMediumCombatProps());

        TankUnit tank_01 = new TankUnit(brigName + " tank 1", acronym + "•1", this.country, false, false, false, 1, combatPropsFactory.getTankMediumCombatProps());
        TankUnit tank_02 = new TankUnit(brigName + " tank 2", acronym + "•2", this.country, false, false, false, 2, combatPropsFactory.getTankMediumCombatProps());

        MotoArtiUnit art_01 = new MotoArtiUnit(brigName + " art 1", acronym + "•1", this.country, false, false, false, 1, combatPropsFactory.getMotoArtiMediumCombatProps(), artiPropsFactory.getArtiMediumRangeMedium());
        MotoArtiUnit art_02 = new MotoArtiUnit(brigName + " art 2", acronym + "•2", this.country, false, false, false, 2, combatPropsFactory.getMotoArtiMediumCombatProps(), artiPropsFactory.getArtiMediumRangeMedium());
