...
public class ObserverPropsBlackCountryFactory implements ObserverPropsFactoryInterface {
    ...
    private final int VISION_RANGE_LOW = 4;
    private final int VISION_RANGE_MEDIUM = 6;
    private final int VISION_RANGE_HIGH = 9;

    private final int VISION_ACCURACY_LOW = 5;
    private final int VISION_ACCURACY_MEDIUM = 7;
    private final int VISION_ACCURACY_HIGH = 10;
