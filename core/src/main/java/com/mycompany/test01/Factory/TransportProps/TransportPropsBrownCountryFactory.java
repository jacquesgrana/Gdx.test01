...
public class TransportPropsBrownCountryFactory implements TransportPropsFactoryInterface {

    private final int CAPACITY_LOW = 20;
    private final int CAPACITY_MEDIUM = 35;
    private final int CAPACITY_HIGH = 80;
