...
public class AirplanePropsRedCountryFactory implements AirplanePropsFactoryInterface {
    ...
    private final int AIR_DEFENSE_HIGH = 11;

    private final int AIR_ATTACK_LOW = 6;
    ...
    private final int VISIBILITY_LOW = 2;
