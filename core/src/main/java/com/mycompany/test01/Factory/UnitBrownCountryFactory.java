...
public class UnitBrownCountryFactory implements UnitFactoryInterface {
    ...
    public CavalryUnit createCavalryUnit(String name, String acronym, boolean isElite, boolean isMotorised, boolean usesWhiteStroke, int regRank) {
        return new CavalryUnit(name, acronym, CountryEnum.BROWN_COUNTRY, isElite, isMotorised, false, usesWhiteStroke, regRank);
    }
    ...
    public ParaUnit createParaUnit(String name, String acronym, boolean isElite, boolean isMotorised, boolean usesWhiteStroke, int regRank) {
        return new ParaUnit(name, acronym, CountryEnum.BROWN_COUNTRY, isElite, isMotorised, false, usesWhiteStroke, regRank);
    }
    ...
    public MarineUnit createMarineUnit(String name, String acronym, boolean isElite, boolean isMotorised, boolean usesWhiteStroke, int regRank) {
        return new MarineUnit(name, acronym, CountryEnum.BROWN_COUNTRY, isElite, isMotorised, false, usesWhiteStroke, regRank);
    }
    ...
    public MecaRecoUnit createMecaRecoUnit(String name, String acronym, boolean isElite, boolean isMotorised, boolean usesWhiteStroke, int regRank) {
        return new MecaRecoUnit(name, acronym, CountryEnum.BROWN_COUNTRY, isElite, isMotorised, false, usesWhiteStroke, regRank);
    }
    ...
    public FrontGroup createFrontGroup(String name, String acronym, boolean isElite, boolean isMotorised, boolean usesWhiteStroke) {
        return new FrontGroup(name, acronym, CountryEnum.BROWN_COUNTRY, isElite, isMotorised, usesWhiteStroke);
    }
    ...
    public ArmyGroupGroup createArmyGroupGroup(String name, String acronym, boolean isElite, boolean isMotorised, boolean usesWhiteStroke) {
        return new ArmyGroupGroup(name, acronym, CountryEnum.BROWN_COUNTRY, isElite, isMotorised, usesWhiteStroke);
    }

    @Override
    public ArmyGroup createArmyGroup(String name, String acronym, boolean isElite, boolean isMotorised, boolean usesWhiteStroke) {
        return new ArmyGroup(name, acronym, CountryEnum.BROWN_COUNTRY, isElite, isMotorised, usesWhiteStroke);
    }
    ...
    public DivisionGroup createDivisionGroup(String name, String acronym, boolean isElite, boolean isMotorised, boolean usesWhiteStroke) {
        return new DivisionGroup(name, acronym, CountryEnum.BROWN_COUNTRY, isElite, isMotorised, usesWhiteStroke);
    }
    ...
    public BrigadeGroup createBrigadeGroup(String name, String acronym, boolean isElite, boolean isMotorised, boolean usesWhiteStroke) {
        return new BrigadeGroup(name, acronym, CountryEnum.BROWN_COUNTRY, isElite, isMotorised, usesWhiteStroke);
    }


    @Override
    public DivisionGroup createInfDivision(String divName, String acronym) {
        DivisionGroup division = new DivisionGroup(divName, acronym, CountryEnum.BROWN_COUNTRY, false, false, false );
        // 3 * 3 inf
        ...
        InfantryRecoCompanyUnit reco_company = new InfantryRecoCompanyUnit(divName + " reco", acronym, CountryEnum.BROWN_COUNTRY, false, false, false, 0);
    ...
    public DivisionGroup createEliteInfDivision(String divName, String acronym) {
        DivisionGroup division = new DivisionGroup(divName, acronym, CountryEnum.BROWN_COUNTRY, true, false, true );
        // 3 * 3 inf
        ...
        // todo 1 reco inf company
        InfantryRecoCompanyUnit reco_company = new InfantryRecoCompanyUnit(divName + " reco", acronym, CountryEnum.BROWN_COUNTRY, true, false, true, 0);
    ...
    public DivisionGroup createMotoInfDivision(String divName, String acronym) {
        DivisionGroup division = new DivisionGroup(divName, acronym, CountryEnum.BROWN_COUNTRY, false, true, false);
