...
public class ObserverPropsRedCountryFactory implements ObserverPropsFactoryInterface {

    private final int VISION_RANGE_LOW = 3;
    private final int VISION_RANGE_MEDIUM = 5;
    private final int VISION_RANGE_HIGH = 7;

    private final int VISION_ACCURACY_LOW = 4;
    private final int VISION_ACCURACY_MEDIUM = 6;
    private final int VISION_ACCURACY_HIGH = 9;
