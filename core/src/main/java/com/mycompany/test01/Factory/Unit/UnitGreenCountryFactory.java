...
public class UnitGreenCountryFactory implements UnitFactoryInterface {
    ...
    private final CombatPropsFactoryInterface combatPropsFactory = new CombatPropsGreenCountryFactory();
    ...
    public DivisionGroup createEliteInfDivision(String divName, String acronym) {
        ...
        HeavyAntiAirUnit anti_air_01 = new HeavyAntiAirUnit(divName + " heavy_anti_air", acronym, this.country, true, false, true, 0, combatPropsFactory.getEngineerInfEliteCombatProps());

        // todo 1 reco inf company
        InfantryRecoCompanyUnit reco_company = new InfantryRecoCompanyUnit(divName + " reco", acronym, this.country, true, true, 0, combatPropsFactory.getEngineerInfEliteCombatProps());
