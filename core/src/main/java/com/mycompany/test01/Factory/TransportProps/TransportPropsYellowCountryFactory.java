...
public class TransportPropsYellowCountryFactory implements TransportPropsFactoryInterface {

    private final int CAPACITY_LOW = 10;
    private final int CAPACITY_MEDIUM = 20;
    private final int CAPACITY_HIGH = 45;
