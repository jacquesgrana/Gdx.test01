...
public class ObserverPropsYellowCountryFactory implements ObserverPropsFactoryInterface {

    private final int VISION_RANGE_LOW = 3;
    private final int VISION_RANGE_MEDIUM = 5;
    private final int VISION_RANGE_HIGH = 6;

    private final int VISION_ACCURACY_LOW = 3;
    private final int VISION_ACCURACY_MEDIUM = 5;
    private final int VISION_ACCURACY_HIGH = 8;
