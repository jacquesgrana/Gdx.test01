...
public class BomberPropsBlueCountryFactory implements BomberPropsFactoryInterface {

    private final int BOMB_ATTACK_LOW = 2;
    private final int BOMB_ATTACK_MEDIUM = 4;
    private final int BOMB_ATTACK_HIGH = 7;
