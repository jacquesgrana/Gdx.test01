...
public class AirplanePropsBrownCountryFactory implements AirplanePropsFactoryInterface {
    ...
    private final int AIR_DEFENSE_MEDIUM = 10;
    private final int AIR_DEFENSE_HIGH = 13;

    private final int AIR_ATTACK_LOW = 9;
    private final int AIR_ATTACK_MEDIUM = 11;
    private final int AIR_ATTACK_HIGH = 16;

    private final int MORAL_LOW = 5;
    private final int MORAL_MEDIUM = 6;
    private final int MORAL_HIGH = 8;

    private final int AGILITY_LOW = 2;
    private final int AGILITY_MEDIUM = 5;
    private final int AGILITY_HIGH = 8;

    private final int SPEED_LOW = 6;
    private final int SPEED_MEDIUM = 8;
    private final int SPEED_HIGH = 11;

    private final int RANGE_LOW = 6;
    private final int RANGE_MEDIUM = 8;
    private final int RANGE_HIGH = 12;
